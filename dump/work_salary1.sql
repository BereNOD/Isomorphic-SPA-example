...
CREATE TABLE `salary1` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_salary1_1_idx` (`worker_id`),
  CONSTRAINT `fk_salary1_1` FOREIGN KEY (`worker_id`) REFERENCES `worker` (`id`)
...
INSERT INTO `salary1` VALUES (1,234,1),(3,345,NULL),(5,345,NULL),(7,345,NULL),(8,345,NULL);
